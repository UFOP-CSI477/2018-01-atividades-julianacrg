...
require_once 'controller/controllerCidade.php';
      ...
      <div class="row section-separator">
        ...
        <div class="form-group">
          <div class="row">
            ...
            ?>
            <form id="cidade" name="cidade" method="post" enctype="multipart/form-data" action="listarCidades.php">
              <div class="form-group">
                <div class="row">
                  <div class="col-sm-4">
                    <label for="nome">Nome:</label>
                      ...
                      <select id="select" name="estado_id" class="form-control" required>
